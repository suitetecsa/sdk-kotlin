...
/**
 * Implementación de la factoría de excepciones que crea instancias de excepciones utilizando una
 * clase de excepción dada.
 *
 * @param exceptionClass La clase de excepción utilizada para crear las instancias de excepción.
 */
internal class ExceptionFactoryImpl(private val exceptionClass: Class<out Exception>) : ExceptionFactory {
    /**
