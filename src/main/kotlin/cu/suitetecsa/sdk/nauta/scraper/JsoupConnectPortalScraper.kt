 ...
 */
class JsoupConnectPortalScraper(
    ...
    class Builder {
        ...
        fun build(): ConnectPortalScraper {
            return JsoupConnectPortalScraper(
                errorParser = errorParser ?: JsoupErrorParser,
                formParser = formParser ?: JsoupFormParser,
                connectionInfoParser = connectionInfoParser ?: JsoupConnectionInfoParser
            )
        }
    }
}
